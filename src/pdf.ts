...
export async function generateMedicationSheetPdf(
  ...
  container.style.cssText =
    "position:fixed;left:-9999px;top:0;width:794px;z-index:-1;pointer-events:none;font-family:'Inter','Noto Sans Thai',sans-serif;background:white;overflow:hidden;";
  document.body.appendChild(container);

  const root: Root = createRoot(container);

  await new Promise<void>((resolve) => {
    root.render(createElement(MedicationSheet, { plan, lang, printLayout: "half-a4" }));
